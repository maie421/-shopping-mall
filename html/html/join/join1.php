...
<html >
  <head>
	...
	<script>
	function check(){
		if(!document.join.agree1.checked)
		{
		alert("이용약관에 동의해주세요.");
		document.join.agree1.focus();
		return;
		}
		if(!document.join.agree2.checked)
		{
		alert("개인정보 수집 및 이용에 동의해주세요.");
		document.join.agree2.focus();
		return;
		}
		if(document.join.agree1.checked && document.join.agree2.checked){
			<? echo("this.document.location ='join.php'; "); ?>
		}
            ...
            <tr>
              <td>
                <div style="margin:18px 0;">
                 <font color="#97b0d1" size=4 >01</font> <font size=3>이용약관</font>
                </div>
             </td>
           </tr>
           <tr>
...
제1조(목적)
 이 약관은 새벽서점 회사(전자상거래 사업자)가 운영하는 새벽서점 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리ㆍ의무 및 책임사항을 규정함을 목적으로 합니다.
    
 ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
 ①“몰” 이란 새벽서점 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" style="margin:10px 0 0 60px;" name="agree1" value="">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
                <div style="margin:18px 0;">
                 <font color="#97b0d1" size=4>02</font> <font size=3>개인정보 수집 및 이용에 대한 안내</font>
                </div>
             </td>
           </tr>
           <tr>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" style="margin:10px 0 0 60px;" name="agree2" value="">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
      </td>
...
<br><br>
  <div class="button_box">
   ...
   <input type="button" class="button_Check" value="회원가입" onclick="check()">
  </div>
  <form>
</div><!--main-->
