...
<? include "../lib/admin_notice.php";?>
  <div id="notice_main">
    ...
    <a href="question_mod.php?num=<?=$num;?>"><div class="write_button" style='margin-top:10px;'>수정</div></a>
    <a href="qeustion_submit.php?num=<?=$num;?>"><div class="write_button" style="margin-top:10px;">답변</div></a>
