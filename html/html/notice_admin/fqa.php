...
if($mode == "search"){
	...
	$sql = "select * from fqa where $find like '%$search%'";
}
else{
	$sql = "select * from fqa order by num desc";
}
...
<div id="notice_main">
    ...
    <table>
      ...
      <tr>
        ...
        <td class="notice_title"><? echo "<a href='fqa_write_in.php?num=$num'>$title</a>";?></td>
	  ...
	  ?>
		...
		<a href="fqa_write.php"><div class="write_button">글쓰기</div></a>
    <!--
    ...
    <ul>
      ...
      <li><button class="page_btn">▶ </button></li>
		...
		for($i = 1; $i <= $total_page; $i++)
		{
			...
			{
				echo "<a href='fqa.php?page=$i'><button class='page_btn'> $i </button></a>";
			}
		}
		if($total_record)
    ...
    <form method="post" action="fqa.php?mode=search">
    <div id="search">
